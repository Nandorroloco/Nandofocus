...
//
//  Versión 814         16/10/2022
//  19/10/2022 El valor del backslash en el comando reset se pone a 0 en lugar de 32 que era el 
//  valor por defecto, y limito el valor entre 0 y 250
//  Introducir el procesador ATTiny88 (working in progress)
// #define Tiny88
//  el posicionamiento sea a velocidad media, será más lento pero más preciso
// #define USB_VERSION
//////////////////////////////////////////////////////////////////
...
mieeprom_t mieeprom;
mieeprom_t reset = {1, 0, 30000, '2', 0, 65000 };
...
void robofocus()
{
  ...
  case 'B':
    ...
    {
      bsdir= N;
      // el backslash ha de ser positivo... y lo limito entre 0 y 250   (19/10/2022)
      if ( posicion < 0)
        posicion = 0;
      else if ( posicion >250)
        posicion = 250;
      backslash = posicion;  
    } 
    set_focuser();
